"""
Django settings for paysecure_backend project.
...
SECRET_KEY = 'django-insecure-ogrnrq3_27vh$(!wvugg7c2ir#1*f6zei2%$qb3hdou=5pkq%8'
...
INSTALLED_APPS = [
    ...
    'paysecure.apps.PaysecureConfig',
...
WSGI_APPLICATION = 'paysecure_backend.wsgi.application'
